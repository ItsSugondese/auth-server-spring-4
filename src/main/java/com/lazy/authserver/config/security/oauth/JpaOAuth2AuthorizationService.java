...
import com.lazy.authserver.entity.oauth.Authorizations;
import com.lazy.authserver.repository.oauth.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
	...
	public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
		...
		Optional<Authorizations> result;
		if (tokenType == null) {
	...
	private OAuth2Authorization toObject(Authorizations entity) {
	...
	private Authorizations toEntity(OAuth2Authorization authorization) {
