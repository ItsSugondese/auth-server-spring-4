...
<div style="width: 824px; margin:0 auto; padding-top:80px; height: 100%;">
    <div style="padding: 24px 32px; height: 100%;">
        <table align="center" width="100%" style="height: auto;">
            ...
            <tr style="margin-bottom: 40px;">
                <td style="text-align: center">
                    <p style="color: #A62A22; font-size:20px;">User authentication attempt requires further verification
                        To complete the verification, click the following url. </p>
                </td>
            </tr>
            <tr style="margin-bottom: 40px;">
                <td style="text-align: center">
                    <a style="text-decoration: none; padding: 16px 24px; background: #A62A22; border-radius: 4px; color: #fff;"
                       href="${url}/${token}"> Click here to verify. </a>
                </td>
            </tr>
            <tr style="margin-bottom: 40px;">
                <td style="text-align: center">
                    <p style="color: #A62A22; font-size:20px;">The code will expire in ${expireTime} .</p>
                </td>
            </tr>
